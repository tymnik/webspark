       ...
       <div class="card-info">
          <div class="details-today">
            ...
            <div class="details-stats">
              <p>
                <svg class="like-icon"><use href="${a}${n.likeIcon}"></use></svg> ${n.likes}
              </p>
              <p>
                <svg class="comment-icon"><use href="${a}${n.commentIcon}"></use></svg> ${n.comments}
              </p>
            </div>
          </div>
          <div class="details-date">
            ...
            <div class="details-date-stats">
              <p>
                <svg class="like-icon"><use href="${a}${n.likeIcon}"></use></svg> ${n.likes2}
              </p>
              <p>
                <svg class="comment-icon"><use href="${a}${n.commentIcon}"></use></svg> ${n.comments2}
              </p>
            </div>
          </div>
          <div class="upload">
